...
const SHOP_SAW = preload("res://scenes/shops/shop_m_249saw.tscn")
const SHOP_M4 = preload("res://scenes/shops/shop_m4A1.tscn")
const SHOP_AK_47 = preload("res://scenes/shops/shop_ak47.tscn")
const SHOP_BENELLI = preload("res://scenes/shops/shop_benelli_M4.tscn")
...
const SHOP_SAURUS = preload("res://scenes/shops/shop_saurus_revolver.tscn")
