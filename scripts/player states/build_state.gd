...
var last_equipped_weapon : Gun
var intersection

func enter():
	last_equipped_weapon = controlled_player.gun
	controlled_player.unequip_weapon()
...
func exit():
	controlled_player.equip_weapon(last_equipped_weapon)
